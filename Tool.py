...
pygame.display.set_caption('决战长空')
...
#加载游戏进行中背景图片
background_image={}
background_image['background1'] = pygame.image.load(path.join(img_dir,'background1.png')).convert()
background_image['background2'] = pygame.image.load(path.join(img_dir,'background2.png')).convert()
background = background_image['background1']
